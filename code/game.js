...
function Player(pos) {
  ...
  this.size = new Vector(1.05, 1);
  this.speed = new Vector(0, 0);
}
Player.prototype.type = "player";

//add new actor as class
function Coin(pos){
...
var floatSpd = 1.5, floatDist = 2;

Ghost.prototype.act = function(step){
  this.float += step * floatSpd;
  var floatPos = Math.sin(this.float) * floatDist;
  this.pos = this.basePos.plus(new Vector(floatPos, 0));
}
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  if (obstacle == "floater"){ //pass through floater
    this.pos = newPos;
  }
